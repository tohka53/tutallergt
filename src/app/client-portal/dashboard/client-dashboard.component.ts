...
export class ClientDashboardComponent implements OnInit {
  ...
  quotationCount = 0;
  serviceCount = 0;
  activeServices: Array<{ service: WorkshopService; vehicle?: Vehicle; photoCount: number }> = [];
  ...
  ngOnInit(): void {
    ...
    combineLatest([
      ...
      this.photos.countsByService(),
      of(clientId),
    ]).subscribe(([vehicles, quotations, services, photoCounts]) => {
