...
export class PartFormDialogComponent {
  ...
  constructor(
    ...
    if (data) {
      this.form.patchValue({
        ...
        category: data.category, suggestedPrice: data.suggestedPrice, type: data.type, active: data.active,
      });
    }
  }
  ...
  save(): void {
    ...
    const payload = {
      ...v, compatibleBrands: this.data?.compatibleBrands ?? [], compatibleModels: this.data?.compatibleModels ?? [],
    };
